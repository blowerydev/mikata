...
setFirst('Grace');`,
  ...
  },
  {
    ...
    apis: [
      ...
      { name: 'show, each, switchMatch, Dynamic', kind: 'Control flow', description: 'Render conditional, list, branch, and dynamic component regions. show() and each() include static options for plain hot paths; the compiler auto-marks obvious static show() JSX.' },
...
export default defineConfig({
  ...
  },
  {
    ...
    apis: [
      ...
      { name: 'escapeAttr(value)', kind: 'Serialization', description: 'Escapes attribute values for custom string emitters.' },
