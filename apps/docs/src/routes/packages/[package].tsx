...
setFirst('Grace');`,
  ...
  },
  {
    ...
    apis: [
      ...
      { name: 'show, each, switchMatch, Dynamic', kind: 'Control flow', description: 'Render conditional, list, branch, and dynamic component regions. show() and each() include static options for plain hot paths.' },
