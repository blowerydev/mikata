...
export const Sun: IconNode = icon(
...
export const Moon: IconNode = icon(
  ['path', { d: 'M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z' }]
);
/** Monitor / display - "system theme" indicator. */
export const Monitor: IconNode = icon(
  ['rect', { x: 2, y: 3, width: 20, height: 14, rx: 2 }],
  ['path', { d: 'M8 21h8' }],
  ['path', { d: 'M12 17v4' }]
);
/** Two overlapping squares - copy. */
export const Copy: IconNode = icon(
  ['rect', { x: 9, y: 9, width: 13, height: 13, rx: 2 }],
  ['path', { d: 'M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1' }]
);
/** GitHub mark - stroke geometry from Lucide so it matches the rest
 *  of the built-in set's defaults (fill=none, stroke=currentColor). */
export const Github: IconNode = icon(
